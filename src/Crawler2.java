...
//    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("crawler2.urlPool count = " + crawler2.mUrlPool.size() + " crawler2.urlPool = " + crawler2.mUrlPool + "mProcessedURLPool count = " + crawler2.mProcessedURLPool.size() + " \n mProcessedURLPool = " + crawler2.mProcessedURLPool);
